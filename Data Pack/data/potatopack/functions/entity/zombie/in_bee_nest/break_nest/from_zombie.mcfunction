execute positioned ~ ~1.5 ~ run function potatopack:entity/zombie/in_bee_nest/break_nest/start
execute positioned ~ ~1.5 ~ run playsound entity.zombie.hurt hostile @a[distance=..16]

# If the nest contains any bees, release them
execute if data entity @s ArmorItems[3].tag.BlockEntityTag.Bees[0] run function potatopack:entity/zombie/in_bee_nest/bee_exit/from_zombie
...
tag @s remove potatopack.entity.zombie.in_bee_nest