...
scoreboard players set @s[predicate=potatopack:technical/location_check/dimension/overworld] potatopack.math 62
scoreboard players set @s[predicate=potatopack:technical/location_check/dimension/the_nether] potatopack.math 31
